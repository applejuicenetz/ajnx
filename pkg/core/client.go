...
type CoreClient interface {
	...
	AddShareDir(ctx context.Context, path string, withSubs bool) error
	RemoveShareDir(ctx context.Context, path string) error
	SetShareDirMode(ctx context.Context, path string, withSubs bool) error
	CheckShares(ctx context.Context) error
	GetDirectories(ctx context.Context, path string) ([]string, error)
